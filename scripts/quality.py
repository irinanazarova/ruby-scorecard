...
the C4 curly-brace heuristic: C4 removed any page that contained "{" (T5/Raffel et al.: "we removed any
pages that contained a curly bracket"), so a single code sample drops the whole page. c4_curly flags it.
