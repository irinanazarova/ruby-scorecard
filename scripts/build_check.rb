  ...
  <body>
    <main class="check-wrap">
      ...
      <p class="lead">Paste a URL. We extract the main text and score it with the open
        ...
        the documented filter behind the FineWeb corpus, then give specific, measured feedback.
        The researchers who build these filters report that people cannot guess their verdicts by eye, so
        measuring beats guessing.</p>
    ...
    <script>
      ...
      function band(s) { return s >= 2.5 ? "hi" : (s >= 1.5 ? "mid" : "lo"); }
